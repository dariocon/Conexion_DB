	            ...
	            while (!salir) {
	                ...
	                switch (opcion) {
	                    ...
	                    case 4:
	                    	...
	                    	System.out.print("Ingrese el email del cliente a actualizar: ");
	                        String emailCliente = scanner.nextLine();

	                    	System.out.print("Ingrese el nombre del campo que se desea actualizar: ");
		                    String campo = scanner.nextLine();
		                    String valor="";
		                    if (campo.equalsIgnoreCase("genero")) {
		                        System.out.print("Ingrese el nuevo género del cliente (M/F): ");
		                        String nuevoGeneroStr = scanner.nextLine();
		                        Genero generoNuevo = Genero.valueOf(nuevoGeneroStr);
		                        valor = generoNuevo.toString();
		                        ...
		                        valor=nuevaFechaNacimiento;
		                    }
		                 

	                        //Cliente clienteActualizado = new Cliente(nuevoNombre, nuevosApellidos, nuevoEmail, nuevaFechaNacimiento, nuevoGenero);	            
	                        connector.actualizarClienteExistente(emailCliente, campo, valor);
	                        System.out.println("Cliente actualizado exitosamente.");
	                        break;
	                    case 5:
	                        // Eliminar un cliente por nombre, apellido e email
	                        ...
	                        System.out.print("Ingrese el email cliente a eliminar: ");
	                        String emailEliminar = scanner.nextLine();
	                        connector.eliminarCliente(nombreClienteEliminar, apellidosClienteEliminar, emailEliminar);
	                        break;
	                    case 6:
	                        ...
	                        Pedido nuevoPedido = new Pedido(codigoPedido, "PROCESANDO", idClientePedido);
